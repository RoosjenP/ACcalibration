...
#' @param country_code The three-letter code of the code as we apply it, e.g.: The Netherlands = 'NLA', Kenya = 'KEA'. Case sensitive, so use capitols.
...
#' @returns This creates a map of the AOI showing the distance in feature space with our calibration points. A raster and a preview of it will be returned.
#' @import terra
#' @examples
